...
import pageobjects.PO_Item_Fleece_Jacket; // Page Object (PO) class for Item3 page.
import pageobjects.PO_Add_To_Cart; // Page Object (PO) class for Cart page.
import pageobjects.PO_Your_Cart; // Page Object (PO) class for Cart page.   
import pageobjects.PO_Your_Information; // Page Object (PO) class for Cart page.
import pageobjects.PO_Overview; // Page Object (PO) class for Cart page.
import pageobjects.PO_Complete; // Page Object (PO) class for Cart page.
...
// filename.]
public class TS_Checkout_JUnit {
    ...
    PO_Item_Backpack po_Item_Backpack;
    PO_Item_Fleece_Jacket po_Item_Fleece_Jacket;
    PO_Add_To_Cart po_Add_To_Cart;
    PO_Your_Cart po_Your_Cart;
    PO_Your_Information po_Your_Information;
    ...
    public void setupTestCase(TestInfo testInfo) {
        ...
        po_Item_Backpack = new PO_Item_Backpack(driver);
        po_Item_Fleece_Jacket = new PO_Item_Fleece_Jacket(driver);
        po_Add_To_Cart = new PO_Add_To_Cart(driver);
        po_Your_Cart = new PO_Your_Cart(driver);
        po_Your_Information = new PO_Your_Information(driver);
        po_Overview = new PO_Overview(driver);
        po_Complete = new PO_Complete(driver);
    }
    ...
    /**
     * Test Case (TC) for Checkout.
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - SwagLabs - Checkout")
    public void tc_swaglabs_AddToCart() {
        ...
        FW_CustomAssertJU.autoPass(po_Products.clickShoppingCart());
        FW_CustomAssertJU.autoPass(po_Your_Cart.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Your_Cart.clickCheckout());
        FW_CustomAssertJU.autoPass(po_Your_Information.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Your_Information.enterFisrt_Name("aaaaa"));
        FW_CustomAssertJU.autoPass(po_Your_Information.enterLast_Name("bbbbb"));
        FW_CustomAssertJU.autoPass(po_Your_Information.enterPostal_Code("00000"));
        FW_CustomAssertJU.autoPass(po_Your_Information.clickContinue());
        FW_CustomAssertJU.autoPass(po_Overview.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Overview.clickFinish());
        FW_CustomAssertJU.autoPass(po_Complete.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Complete.clickBack_Home());
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        ...
        FW_ReportUtils.recordNote("This record is all about Checkout.");
    }
