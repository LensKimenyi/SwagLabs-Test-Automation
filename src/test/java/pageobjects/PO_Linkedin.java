...
public class PO_Linkedin extends FW_Page {
    ...
    private static final String LO_TXT_SIGN_IN = "//h2[contains(text(),'Sign in to see who you already know at Sauce Labs')]";
    ...
    public String validateOnPage() {
        String result = validateLocatorExists(LO_TXT_SIGN_IN, FW_ConfigMgr.getDefaultTimeout(),
