...
public class PO_Login extends FW_Page {
    ...
    private static final String LO_LBL_ERROR = "//h3[@data-test='error']";
    ...
    public String validateOnPage() {
        String result = validateLocatorExists(LO_EDT_USERNAME, FW_ConfigMgr.getDefaultTimeout(),
    ...
    public String verifyErrorMessage(String message) {
        String result = validateWithinLocatorText(LO_LBL_ERROR, message, FW_ConfigMgr.getDefaultTimeout(),
                FW_ConfigMgr.getDefaultInterval(), true);
        result = FW_StringUtils.metaInsert(result, getClass().getSimpleName()); // Insert PO name into results
        return result;
    }
