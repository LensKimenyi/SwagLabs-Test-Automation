...
// filename.]
public class PO_Item_Backpack extends FW_Page {

    // [Note: Automation Engineer, define the Page Object (PO) locators (LO) here.]
    private static final String LO_TXT_SAUCELABSBACKPACK = "//div[contains(text(), 'Sauce Labs Backpack')]";
    ...
    // [Note: Automation Engineer, rename this Page Object (PO) class to match the
    // filename.]
    public PO_Item_Backpack(WebDriver driver) {
        super(driver);
    }
    ...
    public String validateOnPage() {
        String result = validateLocatorExists(LO_TXT_SAUCELABSBACKPACK, FW_ConfigMgr.getDefaultTimeout(),
    ...
    public String clickRemove() {
        String result = clickLocator(LO_BUT_REMOVE, FW_ConfigMgr.getDefaultTimeout());
        result = FW_StringUtils.metaInsert(result, getClass().getSimpleName());
        return result;
    }
}