...
// filename.]
public class PO_Overview extends FW_Page {

    // [Note: Automation Engineer, define the Page Object (PO) locators (LO) here.] 
    private static final String LO_TXT_OVERVIEW = "//span[@data-test='title']";
    private static final String LO_BUT_FINISH = "//button[@id='finish']";
    ...
    // [Note: Automation Engineer, rename this Page Object (PO) class to match the
    // filename.]
    public PO_Overview(WebDriver driver) {
        super(driver);
    }
    ...
    public String validateOnPage() {
        String result = validateLocatorExists(LO_TXT_OVERVIEW, FW_ConfigMgr.getDefaultTimeout(),
    ...
    public String clickFinish() {
        String result = clickLocator(LO_BUT_FINISH, FW_ConfigMgr.getDefaultTimeout());
        result = FW_StringUtils.metaInsert(result, getClass().getSimpleName());
        return result;
    }
