...
import pageobjects.PO_Item_All_The_Things; // Page Object (PO) class for Item5 page. 
...
public class TS_Product_JUnit {
    ...
    PO_Item_All_The_Things po_Item_All_The_Things;
    ...
    public void setupTestCase(TestInfo testInfo) {
        ...
        po_Item_All_The_Things = new PO_Item_All_The_Things(driver);
    ...
    /**
     * Test Case (TC) for SwagLabs Backpack.
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - SwagLabs - Sauce Labs Backpack")
    public void tc_swaglabs_Backpack() {
    ...
    /**
     * Test Case (TC) for SwagLabs Fleece Jacket.
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - SwagLabs - Fleece Jacket")
    public void tc_swaglabs_FleeceJacket() {
        FW_CustomAssertJU.autoPass(po_Login.navigateTo("https://www.saucedemo.com/"));
        FW_CustomAssertJU.autoPass(po_Login.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Login.enterUsername("standard_user"));
        FW_CustomAssertJU.autoPass(po_Login.enterPassword("secret_sauce"));
        ...
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        FW_ScreenUtils.takeScreenshot(driver, "Sample", FW_ConfigMgr.getScreenCaptureDirectory());
        FW_ReportUtils.recordNote("This record is all about Fleece Jacket.");
    }

    /**
     * Test Case (TC) for SwagLabs Test All The Things.
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - SwagLabs - All The Things")
    public void tc_swaaglabs_AllTheThings() {
        FW_CustomAssertJU.autoPass(po_Login.navigateTo("https://www.saucedemo.com/"));
        FW_CustomAssertJU.autoPass(po_Login.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Login.enterUsername("standard_user"));
        FW_CustomAssertJU.autoPass(po_Login.enterPassword("secret_sauce"));
        FW_CustomAssertJU.autoPass(po_Login.clickLogin());
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Products.clickSwagLabsAllTheThings());
        FW_CustomAssertJU.autoPass(po_Item_All_The_Things.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_All_The_Things.clickBackToProducts());
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Products.clickSwagLabsHamburger());
        FW_CustomAssertJU.autoPass(po_Products.clickSwagLabsLogout());
        FW_CustomAssertJU.autoPass(po_Login.validateOnPage());
        FW_ScreenUtils.takeScreenshot(driver, "Sample", FW_ConfigMgr.getScreenCaptureDirectory());
        FW_ReportUtils.recordNote("This record is all about All The Things.");
    }
