...
public class TS_Cart_JUnit {
    ...
    /**
     * Test Case (TC) for Add To Cart.
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - SwagLabs - Add To Cart")
    public void tc_swaglabs_AddToCart() {
        ...
        FW_CustomAssertJU.autoPass(po_Products.clickSwagLabsBackpack());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.clickAddToCart());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.clickBackToProducts());
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Products.clickSwagLabsFleeceJacket());
        FW_CustomAssertJU.autoPass(po_Item_Fleece_Jacket.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_Fleece_Jacket.clickAddToCart());
        FW_CustomAssertJU.autoPass(po_Item_Fleece_Jacket.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_Fleece_Jacket.clickBackToProducts());
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        ...
        FW_ReportUtils.recordNote("This record is all about Backpack.");
    }

    /**
     * Test Case (TC) for Remove To Cart.
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - SwagLabs - Remove To Cart")
    public void tc_swaglabs_RemoveToCart() {
        FW_CustomAssertJU.autoPass(po_Login.navigateTo("https://www.saucedemo.com/"));
        FW_CustomAssertJU.autoPass(po_Login.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Login.enterUsername("standard_user"));
        FW_CustomAssertJU.autoPass(po_Login.enterPassword("secret_sauce"));
        ...
        FW_CustomAssertJU.autoPass(po_Your_Cart.clickSwagLabsBackpack());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.clickRemove());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Item_Backpack.clickBackToProducts());
        FW_CustomAssertJU.autoPass(po_Products.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Products.clickSwagLabsHamburger());
        ...
        FW_CustomAssertJU.autoPass(po_Login.validateOnPage());
        FW_ScreenUtils.takeScreenshot(driver, "Sample", FW_ConfigMgr.getScreenCaptureDirectory());
        FW_ReportUtils.recordNote("This record is all about Remove to cart.");
    }
